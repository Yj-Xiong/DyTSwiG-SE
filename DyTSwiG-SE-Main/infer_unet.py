...
def inference(args, device):
    ...
    segment_size = cfg['stft_cfg']['segment_size']
...
def main():
    ...
    config_file = '/home/xyj/Experience/PrimeK-Net-main/config_SEUNet.json'
