...
def main():
    ...
    #parser.add_argument('--input_training_file', default='/home/xyj/Experiments/MP-SENet/VoiceBank+DEMAND/training.txt')
    #parser.add_argument('--input_validation_file', default='/home/xyj/Experiments/MP-SENet/VoiceBank+DEMAND/test.txt')
    parser.add_argument('--group_name', default=None)
